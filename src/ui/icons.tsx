...
import { IconArrowRight, IconMenu2, IconSun, IconMoon, IconArticle, IconUser, IconLogout2, IconTrash, IconEye, IconEdit, IconHeading, IconH1, IconH2, IconH3, IconLink, IconBlockquote, IconCode, IconPhoto, IconList, IconListNumbers, IconBold, IconItalic, IconSquareX, IconPencilPlus, IconCategory } from '@tabler/icons-react';
...
export const CloseIcon = ({ customClass }: { customClass: string | null }) => <IconArrowRight size={30} className={`${customClass}`} />
export const CreateIcon = () => <IconPencilPlus size={22} />
// export const MenuIcon = () => <IconCategory size={22} />
export const MenuIcon = ({ customClass }: { customClass: string | null }) => <IconMenu2 size={22} className={`${customClass}`} />
